import{_ as s,o as n,c as a,O as e}from"./chunks/framework.12bd0347.js";const y=JSON.parse('{"title":"部署web项目","description":"","frontmatter":{},"headers":[],"relativePath":"src/framework/github-actions/index.md","filePath":"src/framework/github-actions/index.md","lastUpdated":1696899580000}'),l={name:"src/framework/github-actions/index.md"},p=e(`<h1 id="部署web项目" tabindex="-1">部署web项目 <a class="header-anchor" href="#部署web项目" aria-label="Permalink to &quot;部署web项目&quot;">​</a></h1><h2 id="部署到阿里云oss" tabindex="-1">部署到阿里云OSS <a class="header-anchor" href="#部署到阿里云oss" aria-label="Permalink to &quot;部署到阿里云OSS&quot;">​</a></h2><div class="language-txt line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#babed8;">name: Deploy to Aliyun OSS</span></span>
